          ...
          <div v-if="activeTab === 'schedule'" class="left-scroll-area">
            <div class="d-flex align-items-center justify-content-between mb-2">
              ...
              <div class="d-flex gap-1">
                <select v-model="schedBranchFilter" class="form-select fc-brand" style="font-size:0.76rem;width:auto">
        ...
        <div class="modal-panel" style="position:relative;z-index:1;" @click.stop>
          <div class="modal-panel-header">
            <div>
              ...
              <div class="modal-sub">{{ staffForm.id ? 'Update staff details' : 'Add a new staff member' }}</div>
            </div>
          ...
          <div class="modal-panel-body">
            <div class="row g-3">
              ...
              <div class="col-6">
                <label class="form-label-sm">Branch</label>
                <select v-model="staffForm.branchId" class="form-select fc-brand">
...
const filteredStaff = computed(() => {
  return staffMembers.value.filter((e) => {
    ...
    if (staffFilterBranch.value && e.branchId !== staffFilterBranch.value) return false;
    return true;
  });
});
...
const openAddStaffModal = () => {
  staffForm.value = { id: null, firstName: "", lastName: "", email: "", phone: "", position: "", department: "", hourlyRate: 0, branchId: "", status: "Active" };
