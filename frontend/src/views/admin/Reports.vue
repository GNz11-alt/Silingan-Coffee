    ...
    <div v-show="mainTab === 'analytics'">
          ...
          <div class="col-12 col-md-6">
            <div class="chart-card">
              <div class="chart-card-header">
                ...
                <div class="chart-sub">
                  Avg orders per hour — use this to plan staffing
                </div>
              </div>
          ...
          <div class="col-12 col-md-6">
            <div class="chart-card">
              <div class="chart-card-header">
                ...
                <div class="chart-sub">
                  % of total revenue per product category
                </div>
              </div>
      ...
      <div v-show="subTab === 'branches'">
        <div class="row g-3 mb-3">
          <div class="col-12 col-md-8">
            <div class="chart-card">
              <div class="chart-card-header">
                ...
                <div class="chart-sub">
                  Net sales per branch · {{ periodLabel }}
                </div>
              </div>
          ...
          <div class="col-12 col-md-4">
            <div class="chart-card">
              ...
              <div
                class="chart-wrap chart-wrap--sm"
                v-show="!chartsLoading.branchShare"
              >
        ...
        <div class="row g-3">
          ...
          <div
            v-if="!branchCompData.length && !chartsLoading.branchRevenue"
            class="col-12"
          >
            ...
            <div class="chart-card">
              ...
              >
                <div>
                  ...
                  <div class="chart-sub">
                    Items at or below reorder level — action required
                  </div>
                </div>
          ...
          <div class="col-12 col-md-6">
            <div class="chart-card">
              <div class="chart-card-header">
                ...
                <div class="chart-sub">
                  Red = under 3 days, Amber = under 7 days
                </div>
              </div>
          ...
          <div class="col-12 col-md-6">
            <div class="chart-card">
              <div class="chart-card-header">
                ...
                <div class="chart-sub">
                  How fast each raw material is used per day
                </div>
              </div>
              <div class="chart-loading" v-if="chartsLoading.stockTurnover">
                <div class="spinner-border spinner-border-sm text-muted"></div>
              ...
              <div v-else class="table-wrap">
                <table class="data-table">
                  ...
                  <tbody>
                    <tr
                      v-for="item in stockTurnoverData.slice(0, 8)"
                      :key="item.name"
                    >
                      <td class="fw-600">{{ item.name }}</td>
                      <td>
                        {{ formatRate(item.daily_consumption_rate) }}
                        {{ item.unit }}/day
                      </td>
                      <td
                        :class="
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="col-title">
                      <div class="report-title-cell">
                        ...
                        <div class="report-title-sub">
                          Generated by {{ r.generator?.firstname || "Admin" }}
                        </div>
                      </div>
                    </td>
                    ...
                    <td class="col-created">
                      {{ formatDate(r.created_at || r.reportdate) }}
                    </td>
                    <td class="col-branch">
                      <span class="badge-branch">{{
                        r.branch?.branchname || "All Branches"
                      }}</span>
                    </td>
        ...
        <div class="col-12 col-lg-5">
          <div class="gen-panel">
            ...
            <div class="mb-3" v-else>
              <div class="info-box">
                <i class="bi bi-info-circle me-2"></i>
                Consolidated report fetches and combines data across
          ...
          <div class="modal-panel-header">
            <div>
              ...
              <p class="modal-sub mb-0">
                ...
                {{ previewData?.branch?.branchname || "All Branches" }}
              </p>
            </div>
          ...
          <div class="modal-panel-body">
            ...
            <div class="preview-placeholder mt-3">
              ...
              <p class="text-muted mt-2 mb-0">
                To re-export this report, use the Generate tab with the same
                parameters.<br />
                <span v-if="previewData?.filepath"
                  >File saved at: <code>{{ previewData.filepath }}</code></span
                >
              </p>
              <a
                v-if="previewData?.filepath"
...
export default {
  ...
  data() {
    ...
    return {
        ...
        consolidated: [
          {
            ...
            label: "Consolidated Report (All Branches)",
          },
        ],
      },
      ...
      reportTemplates: [
        ...
        {
          key: "consolidated",
          name: "Branch Consolidated Report",
          desc: "Combined performance data across all branches",
  ...
  methods: {
    ...
    async loadBranchComp(from, to, branch) {
      ...
      delete this.chartErrors.branchRevenue;
      delete this.chartErrors.branchShare;
    ...
    async loadInsights() {
      ...
      try {
        ...
        const [kpiRes, agingRes, schedRes] = await Promise.all([
          ...
          supabase.rpc("get_inventory_aging", {
            p_date_from: from,
            p_date_to: to,
            p_branch_id: branch || null,
          }),
          supabase.rpc("report_employee_schedule", {
            p_date_from: from,
            p_date_to: to,
            p_branch_id: branch || null,
          }),
        ...
        this.insightsLastRun = new Date().toLocaleTimeString("en-PH", {
          hour: "2-digit",
          minute: "2-digit",
        });
        ...
        for (const f of this.insightsData?.findings || []) {
          ...
          const linkPath = f.link?.module ? `/${role}/${f.link.module}` : null;
          await supabase
            .from("notifications")
            .insert({
              role,
    ...
    async generateReport() {
      ...
      try {
        ...
        const branchName = this.genForm.branchId
          ? this.branches.find((b) => b.branchid === this.genForm.branchId)
              ?.branchname || "Branch"
          : "All Branches";
        const meta = {
...
.narrative-card.narrative--high {
  border-left: 3px solid #7b1d1d;
}
.narrative-card.narrative--medium {
  border-left: 3px solid #d97706;
}
.narrative-card.narrative--low {
